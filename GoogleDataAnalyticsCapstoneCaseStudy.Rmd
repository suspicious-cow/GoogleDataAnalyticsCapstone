...
## Summary Statistics
Finally, we run some summary statistics to get an overall view of the data 
...
* __The cleaning process__ is documented in this markdown document. It includes 
...
shared or reviewed at a later date.
