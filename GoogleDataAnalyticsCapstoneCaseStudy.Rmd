...
# Business Questions
The primary business questions we aim to address are: 
...
two groups (member and casual renters), and will be instrumental in forming the 
foundation for a marketing strategy aimed at converting casual riders into 
annual members. The strategy will be developed in alignment with these insights, 
addressing the unique needs and behaviors of casual riders to motivate their 
transition to becoming annual members.
...
# Share
This paper serves as our vehicle for sharing the insights gained. In it you will 
find all the relevant visuals as well as the source code so the results can be 
reproduced independently. Questions or comments should be directed to Zain 
Naboulsi. 
